...
interface PartnersProps {
  onDonate: () => void;
  onPartnerOnboarding: () => void;
}

const Partners: React.FC<PartnersProps> = ({ onDonate, onPartnerOnboarding }) => {
    ...
    const unsubscribe = onSnapshot(partnersQuery, (snapshot) => {
      ...
      if (partnersData.length > 0) {
        ...
        setPartners([
          {
            id: '1',
            name: 'Pad-a-Girl Foundation',
            logo: 'https://picsum.photos/seed/padagirl/200/200',
            description: 'A non-profit organization dedicated to providing sanitary pads to girls in rural communities and schools.',
            website: 'https://example.org/padagirl',
            type: 'donor'
          },
          {
            id: '2',
            name: 'Health First Initiative',
            logo: 'https://picsum.photos/seed/healthfirst/200/200',
            description: 'Provides comprehensive menstrual health education and hygiene workshops for adolescents.',
            website: 'https://example.org/healthfirst',
            type: 'educator'
          },
          {
            id: '3',
            name: 'Global Period Equity',
            logo: 'https://picsum.photos/seed/period/200/200',
            description: 'International partner supporting local initiatives with both product donations and educational resources.',
            website: 'https://example.org/period-equity',
            type: 'both'
          }
        ]);
      }
      ...
      <div className="space-y-4">
        ...
        {partners.map((partner) => (
          ...
          >
            ...
            <button className="w-full py-3 bg-brand-50 text-brand-600 rounded-xl font-bold text-xs flex items-center justify-center gap-2 hover:bg-brand-100 transition-colors group">
